          ...
          {visualizationData && (
            <div className="space-y-4 sm:space-y-6 w-full min-w-0 p-4 sm:p-6">
              ...
              <div className="space-y-4 sm:space-y-6 w-full">
                ...
                {visualizationData.figures.collaborations_plot && (
                  <div className="bg-white p-3 sm:p-4 rounded-lg shadow-sm border border-gray-200 w-full">
                    <div className="w-full h-[500px] min-w-0">
                      <Plot
                        data={visualizationData.figures.collaborations_plot.data}
                        layout={{
                          ...visualizationData.figures.collaborations_plot.layout,
                          autosize: true,
                          width: null,
                          height: null,
                          margin: { l: 50, r: 50, b: 50, t: 50, pad: 4 }
