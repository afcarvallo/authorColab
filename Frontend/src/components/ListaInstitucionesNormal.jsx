...
const ListaInstitucionesNormal = () => {
  const { 
    instituciones, 
    ...
    return (
      <div className="h-full flex items-center justify-center">
        <div className="text-gray-500 text-center">
          ...
          <p className="text-sm mt-2">Realiza una búsqueda para ver resultados</p>
        </div>
      </div>
    );
  }
        ...
        <div className="p-2">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex flex-wrap gap-2 text-xs text-gray-600 mb-1">
                    <span className="flex items-center space-x-1">
                      <span>📚</span>
                      <span>{institucion.total_trabajos || 0} trabajos</span>
                    </span>
          ...
          {institucionesVisibles < institucionesOrdenadas.length && (
            <div className="mt-4 mb-2 text-center">
              ...
              >
                Cargar más ({institucionesOrdenadas.length - institucionesVisibles} restantes)
              </button>
            </div>
          )}
        </div>
